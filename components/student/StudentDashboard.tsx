...
// --- MOCK DATA ---
const MOCK_TASKS = [
  { id: 't1', type: TaskType.THEME_SELECTION, status: TaskStatus.PENDING, deadline: '2026-10-15', description: '从五大主题中选取你的调查方向，并上传初步调查方案。' },
                 ...
                 <div className="flex items-start justify-between gap-4 mb-4">
                    <h4 className="text-lg font-bold text-slate-800 leading-tight">
                        {task.type === TaskType.THEME_SELECTION ? '1. 调查选题确认' :
                         task.type === TaskType.PROCESS_MATERIAL ? '2. 过程性材料' : '3. 结项报告'}
                    </h4>
